...
<section class="relative h-[40vh] flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="../assets/img/nail_couture.png" alt="Nails Hero" class="w-full h-full object-cover opacity-60">
    ...
    <div class="relative z-10 text-center reveal">
        ...
        <h1 class="text-5xl md:text-7xl font-playfair text-white mb-6">Couture <span class="italic text-accent text-glow">Nails</span></h1>
...
<div class="py-10 bg-white text-center">
    <div class="flex flex-wrap justify-center gap-8 font-sans text-xs uppercase tracking-[0.3em] text-neutral-muted">
        ...
        <a href="nails.php" class="hover:text-accent transition-colors text-accent border-b border-accent pb-1">Nails</a>
...
<section class="py-20 px-10 bg-white">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div class="group relative overflow-hidden rounded-2xl reveal shadow-xl">
            <img src="../assets/img/nail_couture.png" alt="Nail Art" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            ...
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Marble & Gold</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Hand Painted</p>
            </div>
        </div>

        <!-- Item 2 -->
        <div class="group relative overflow-hidden rounded-2xl reveal delay-100 shadow-xl">
            <img src="../assets/img/female-hand-with-purple-nail-design-holding-beautiful-pink-tulip.jpg" alt="Nail Art" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            <div class="absolute inset-0 bg-gradient-to-t from-neutral-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Artisan Polish</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Couture Enamel</p>
            </div>
        </div>

        <!-- Item 3 -->
        <div class="group relative overflow-hidden rounded-2xl reveal delay-200 shadow-xl">
            <img src="../assets/img/woman-with-nail-art-promoting-design-luxury-earrings-ring.jpg" alt="Nail Care" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            <div class="absolute inset-0 bg-gradient-to-t from-neutral-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Velvet Finish</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Matte Elegance</p>
            </div>
        </div>
    </div>
</section>
