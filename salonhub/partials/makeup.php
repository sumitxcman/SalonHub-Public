...
<section class="relative h-[40vh] flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="../assets/img/makeup_artistry.png" alt="Makeup Hero" class="w-full h-full object-cover opacity-60">
    ...
    <div class="relative z-10 text-center reveal">
        ...
        <h1 class="text-5xl md:text-7xl font-playfair text-white mb-6">Makeup <span class="italic text-accent text-glow">Mastery</span></h1>
...
<div class="py-10 bg-white text-center">
    <div class="flex flex-wrap justify-center gap-8 font-sans text-xs uppercase tracking-[0.3em] text-neutral-muted">
        ...
        <a href="makeup.php" class="hover:text-accent transition-colors text-accent border-b border-accent pb-1">Makeup</a>
...
<section class="py-20 px-10 bg-white">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div class="group relative overflow-hidden rounded-2xl reveal shadow-xl">
            <img src="../assets/img/makeup_artistry.png" alt="Makeup Art" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            ...
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Bridal Glow</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Wedding Artistry</p>
            </div>
        </div>

        <!-- Item 2 -->
        <div class="group relative overflow-hidden rounded-2xl reveal delay-100 shadow-xl">
            <img src="../assets/img/celebration-navratri-png.jpg" alt="Makeup" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            <div class="absolute inset-0 bg-gradient-to-t from-neutral-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Editorial Vogue</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Fashion Shoot</p>
            </div>
        </div>

        <!-- Item 3 -->
        <div class="group relative overflow-hidden rounded-2xl reveal delay-200 shadow-xl">
            <img src="../assets/img/front-view-young-beautiful-female-flower-designed-shirt-blue-jeans-doing-make-up-with-slight-smile-pink-background.jpg" alt="Makeup" class="w-full h-[400px] object-cover transition-transform duration-1000 group-hover:scale-110">
            <div class="absolute inset-0 bg-gradient-to-t from-neutral-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
            <div class="absolute bottom-0 p-8 translate-y-10 group-hover:translate-y-0 transition-transform duration-700">
                <h4 class="text-white font-playfair text-2xl mb-2">Glamour Night</h4>
                <p class="text-accent text-xs uppercase tracking-widest font-bold">Event Makeup</p>
            </div>
        </div>
    </div>
</section>
